...
class Backend5 extends CI_Controller{

 public function __construct()
{
    parent::__construct();
    $this->load->model("alumnos5_model");
...
public function alumnos(){
    ...
    $data = $this->alumnos5_model->get_alumnos();
...
public function actualizaalumno(){
    ...
    if ($accion == "alta") {
        ...
        $row = $this->alumnos5_model->get_alumno($id);
        if ($row != NULL) {
            $obj = array(
                "resultado" => false,
        ...
        $obj["resultado"] = $this->alumnos5_model->update_alumno($data);
...
public function borraalumno(){
    ...
    $obj["resultado"] = $this->alumnos5_model->delete_alumno($id);
