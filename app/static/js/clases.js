            ...
            $("#tabla-clase")
              ...
              .append(
                '<tr id="tr-' +
                  ...
                  "</td>" +
                  '<td class="text-center">' +
                  '<button class="btn btn-sm btn-primary me-2" onclick="click_editar(\'' +
                  a.id +
                  '\')" title="Editar alumno"><i class="fas fa-edit" data-bs-toggle="modal" data-bs-target="#modal-editar"></i></button>' +
                  '<button class="btn btn-sm btn-danger me-2" onclick="appData.id=\'' +
                  a.id +
                  '\';" title="Borrar alumno"><i class="fas fa-trash" data-bs-toggle="modal" data-bs-target="#modal-baja"></i></button>' +
                  "</td>" +
                  "</tr>"
              );
          }
...
var fechasOrdenadas = Object.keys(clasesPorDia).sort(function(a, b) {
  ...
  title: {
    text: "Cantidad de Clases por Dia",
  },
  xAxis: {
    type: "category",
    title: {
